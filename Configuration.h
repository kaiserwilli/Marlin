...
#define STRING_CONFIG_H_AUTHOR "(Benjamin Wilhelm, Folgertech Prusa i3)" // Who made the changes.
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z False //disabled for z home offset adjustment
#endif
